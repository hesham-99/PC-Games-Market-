...
<div className='navSpas'></div>
    ...
    <div className='ContactP'>
      ...
      <a target="_blank" href="https://maps.app.goo.gl/zp5F7z379rqaAyHo8?g_st=awb" className="location  animate__animated animate__flash"><i class="bi bi-linkedin"><Image style={{height:'100px'}} className='mediaImg' src={require("./extrafiel/3img/media/location.png")} alt="location" /></i></a>
      </div></div>
      </div>
