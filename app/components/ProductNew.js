                ...
                <li key={product.id}  className='liImgcartsmart'>
                  ...
                  <img className='Imgcartsmart' src={product.image} loading='lazy' alt={product.title} />
                     <div className='dataImgcartsmart'>
                      ...
                      <img  className='liImgcartsmartSwiperImg' src={product.imageA} loading='lazy' alt={'a'}  onClick={()=>{setLiImgcartsmartSwiperImg(product.imageA)}}/>
                      <img  className='liImgcartsmartSwiperImg' src={product.imageB} loading='lazy' alt={'b'}  onClick={()=>{setLiImgcartsmartSwiperImg(product.imageB)}}/>
                      <img  className='liImgcartsmartSwiperImg' src={product.imageC} loading='lazy' alt={'c'}  onClick={()=>{setLiImgcartsmartSwiperImg(product.imageC)}} />
                      <img  className='liImgcartsmartSwiperImg' src={product.imageD} loading='lazy' alt={'d'}  onClick={()=>{setLiImgcartsmartSwiperImg(product.imageD)}} />
                      </div>
                      <hr />
